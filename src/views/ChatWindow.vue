...
export default {
    data() {
        ...
        handleEmoji(unicode) {
            const textarea = this.$refs.textarea // 获取 textarea 元素
            const startPos = textarea.selectionStart    // 获取光标位置
            ...
            textarea.selectionStart = newCursorPos // 更新光标位置并聚焦文本区域
