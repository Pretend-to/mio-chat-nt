...
export default {
    data() {
        ...
        const configging = false
        const user = getmain()
        const cfg = getconfig()
        const currentstatus = (path === '/setting' ? 1 : 0)
        return {
            user,
            configging,
            currentstatus,
...
<template>
    <div id="sidebar">
        ...
        <div class="options" id="side">
            <div class="up-half">
                <RouterLink to="/">
                    <div @click="tochatting" class="side-icon" :id="chatting">
                ...
                <div @click="tocontactor" class="side-icon" :id="editing">
